...
DATA_DIR = Path("tablas")

COLEGIOS_PATH = DATA_DIR / "colegios.csv"
TALLAS_PATH = DATA_DIR / "tallas.csv"
PRECIOS_PATH = DATA_DIR / "precios.csv"
INVENTARIO_PATH = DATA_DIR / "inventario.csv"
VENTAS_PATH = DATA_DIR / "ventas_df.csv"
FACTURACION_PATH = DATA_DIR / "facturacion_ventas.csv"
...
#    archivo_colegio = DATA_DIR / f"{colegio}.csv"
#
